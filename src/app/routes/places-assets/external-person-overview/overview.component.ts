...
@Component({
  selector: 'app-external-places-assets-overview',
  templateUrl: './overview.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ExternalPersonPlacesAssetsOverviewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.paramMap.pipe(
      switchMap((params: ParamMap) => {
        this.title = 'Übersicht für ' + params.get('id');
        this.list = [];
          return this.placesAssetsSrv.listByExternalPerson(100, 0, params.get('id'))
        }
